...
public class BST_Generic_Driver
{
   ...
   {
      BST_Generic<Integer> treeOfIntegers = new BST_Generic<Integer>(); // used to say tree of widgets?
    ...
    /*
      ...
      */         
      ...
      kb.close(); // NOTE: It is very very important to close Scanner objects after using them!!!!!!!!!!!!!!
